...
CREATE TABLE "Token" (
    ...
    "token" TEXT NOT NULL DEFAULT 'token init',
    "emailToken" TEXT,
...
CREATE TABLE "Campaign" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "classesType" "ClassType" NOT NULL DEFAULT 'DYNAMIC',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "userId" INTEGER NOT NULL,
...
CREATE TABLE "Class" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "type" "ClassType" NOT NULL DEFAULT 'DYNAMIC',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "_CampaignToClass" ADD CONSTRAINT "_CampaignToClass_A_fkey" FOREIGN KEY ("A") REFERENCES "Campaign"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CampaignToClass" ADD CONSTRAINT "_CampaignToClass_B_fkey" FOREIGN KEY ("B") REFERENCES "Class"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CampaignToHarvest" ADD CONSTRAINT "_CampaignToHarvest_A_fkey" FOREIGN KEY ("A") REFERENCES "Campaign"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CampaignToHarvest" ADD CONSTRAINT "_CampaignToHarvest_B_fkey" FOREIGN KEY ("B") REFERENCES "Harvest"("id") ON DELETE CASCADE ON UPDATE CASCADE;
